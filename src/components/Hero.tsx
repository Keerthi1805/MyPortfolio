    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          >
            Hi, I'm{" "}
            <span className="text-gradient">Bhuvana Keerthi</span>
          </motion.h1>
          ...
          >
            Computer Science student passionate about building secure, scalable, and user-focused applications. 
            Skilled in full-stack development, AI-driven solutions, and cloud-native systems.
          </motion.p>
          ...
          >
            <a
              ...
              className="p-3 rounded-full border border-border bg-card/50 hover:bg-card hover:border-primary/50 transition-all duration-300"
            >
